    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('rol', models.CharField(choices=[('admin', 'Administrador'), ('miembro', 'Miembro'), ('invitado', 'Invitado')], default='miembro', max_length=20)),
                ('miembros', models.ManyToManyField(related_name='grupos_donde_soy_miembro', to=settings.AUTH_USER_MODEL)),
                ('usuarios', models.ManyToManyField(related_name='grupos_donde_soy_usuario', to=settings.AUTH_USER_MODEL)),
                ('proyecto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grupos', to='proyectos.proyecto')),
            ],
        ),
        migrations.CreateModel(
            name='Tarea',
